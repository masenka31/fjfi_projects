...
gf = gif(animation, "gifs/animace_ks=$ks.gif", fps=5)

# vizualizace hustot mřížky
hustotaT = hustota ./ sim_time[end]
hustotaT[souradnice_prekazek] .= -0.05
heatmap(hustotaT',axis=([],false),aspect_ratio=:equal,color=:jet)
savefig("plots/heatmap_ks=$ks.pdf")